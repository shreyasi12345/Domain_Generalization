...
def add_args(parser):
    ...
    train.add_argument('--t', type=float, default=1.0,
                       help='temperature scaling factor for loss function')
    train.add_argument('--loss_function', type=str, default='EntropyMaximization',
                       help='loss_function')
    train.add_argument('--class_list', type=str, default='Tree',
                       help='class_list')
    return train
